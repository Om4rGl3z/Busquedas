...
int main()
{
    ...
    do
    {
        ...
        case 2:
            ...
            break;
        case 3:
            cout<<"Da los datos del alumno que quiere buscar.\n:";
            cin>>a;
            pos=MiCola.BusquedaLineal(a);
            if(pos==0){
                cout<<"Faltan:"<<MiCola.ultimo()-pos<<" aspirantes para que siga su turno."<<endl<<endl;

            }
            if(pos>0){
                 cout<<"Ya es tu turno."<<endl<<endl;
